...
class Content(unittest.TestCase):
    ...
    def test_it_carries_the_full_published_roster(self):
        self.assertEqual(len(self.parsed.agents), 47)

    def test_it_splits_into_sixteen_available_and_thirty_one_planned(self):
    ...
    def test_spectra_ships_exactly_seven_agents_today(self):
