...
class Content(unittest.TestCase):
    ...
    def test_it_carries_the_full_published_roster(self):
        self.assertEqual(len(self.parsed.agents), 44)

    def test_it_splits_into_thirteen_available_and_thirty_one_planned(self):
    ...
    def test_spectra_ships_exactly_four_agents_today(self):
        self.assertEqual(sorted(a.id for a in self.parsed.shipped()),
                         ["adr", "brd", "create-pr", "domain-analyzer"])
