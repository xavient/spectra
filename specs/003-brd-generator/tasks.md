...
- [X] T001 [P] Create `spectra/templates/` and copy `brds/template.md` verbatim to `spectra/templates/brd-template.md` (the shipped BRD template asset — research.md D1).
